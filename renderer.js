// renderer.js (organizado por seções)

window.addEventListener('DOMContentLoaded', () => {
  // Declaração de vars do elementos DOM
  ...
  //toast (informação  flutuante) do Bootstrap gatilhado por eventos (exclusão, edição, adição)
  ...
  // Validação para inserção APENAS numérica
  ...
  // Limpeza do formulário para UI mais agradável
  ...
  // Renderização da lista de produtos por ordem decrescente de inserção
  ...
  // Botão para listar todos os produtos inseridos
